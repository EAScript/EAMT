...
setup(
  ...
  packages = ['EAMetatrader'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/EAScript/EAMT/archive/refs/tags/1.0.1.tar.gz',    # I explain this later on
  ...
  package_data={"EAMetatrader.Client": ['MtApi.dll','Newtonsoft.Json.dll'],
                "EAMetatrader.Using": ['System.Drawing.dll','WindowsBase.dll']},
  classifiers=[
